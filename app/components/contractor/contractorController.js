...
ticketFixApp.controller('ModalEmailMgrInstanceCtrl', function($scope, $uibModalInstance, items) {
    ...
    $scope.emailName = items.emailName;
    ...
    $scope.ok = function() {
        ...
        if ($scope.emailName) {
            html = "<div> [Sender's name: " + $scope.emailName + "]<br/></div>" + "<div>" + $scope.emailBody + "</div>";
            text = "[Sender's name: " + $scope.emailName + "] : " + $scope.emailBody;
        } else {
