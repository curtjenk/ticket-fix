var ticketFixApp = angular.module('ticketFixApp', ['ui.router', 'ui.bootstrap', 'angularUtils.directives.dirPagination', 'dndLists', 'ngMessages', 'LocalStorageModule', 'ngMaterial', 'ngSanitize', 'chart.js']);
